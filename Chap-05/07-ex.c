...
/* 7. Supprimez de manière mécanique la récursion du programme `POSTFIXE` présenté dans le texte pour obtenir une version itérative. */
...
/* version itérative du pacours postfixe */
void postfixe(node pt)
{
  struct Node * p2 = NULL;
